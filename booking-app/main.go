...
func main() {
	...
	for {
		...
		isValidName, isValidEmail, isValidTicketNumber := valideUserInput(firstName, lastName, email, userTickets)
...
func valideUserInput(firstName string, lastName string, email string, userTickets uint) (bool, bool, bool) {
